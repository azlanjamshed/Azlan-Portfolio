...
const projects = [
  {
    ...
    status: "Done",
    description:
      "A complete frontend website for a legal and service consultancy firm, built with React and Tailwind CSS. Includes structured service pages, contact section, responsive layouts, and SEO-friendly design.",
  ...
  },
  {
    ...
    type: "Frontend",
    description:
      "A responsive football league standings and match-center app built using React and Tailwind CSS, featuring dynamic team data, auto-computed points table, and clean UI with smooth interactions.",
    techStack: ["React", "Tailwind CSS"],
  ...
  },
  {
    ...
    status: "Completed",
    description:
      "A full-stack quiz platform built with the MERN stack, enabling users to create, manage, and participate in interactive quizzes. Features secure JWT authentication, real-time quiz participation, leaderboard, score tracking, and an intuitive admin dashboard for managing quizzes, questions, and users.",
    techStack: [
      "MongoDB",
      "Express.js",
      "React",
    ...
    gitLink: "https://github.com/azlanjamshed/QuizFlow",
  },
  // {
  //     image: todo,
  //     title: "ToDo App",
  ...
  // },
  {
    ...
    status: "In Progress",
    description:
      "A full-stack School Management System built with the MERN stack to manage students, teachers, classes, and marks. Implemented role-based authentication (Admin, Teacher, Student) with secure backend APIs. Currently developing frontend dashboards for Teacher and Student modules.",
